...
contract PredictionMarket is Ownable, ReentrancyGuard {
    ...
    function buyuShares(
        ...
        require(!market.resolved, "Market has already resolved");
        ...
        )
    {
        Market storage market = markets[_marketId];
        return (
            string(abi.encodePacked(market.question)),
            market.endTime,
            market.outcome,
            string(abi.encodePacked(market.optionA)),
            string(abi.encodePacked(market.optionB)),
